...
def create_pq_acc_buttons_control(packer, bus, buttonStatesToSend, CS, idx):
  ...
  values = {
    ...
    "GRA_Up_kurz":  1 if (buttonStatesToSend["accelCruise"] or CS.buttonStates["accelCruise"]) else 0,
    "GRA_Down_kurz":  1 if (buttonStatesToSend["decelCruise"] or CS.buttonStates["decelCruise"]) else 0,
  }
