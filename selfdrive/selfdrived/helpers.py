...
class DriverMonitoring:
  ...
  def _update_events(self, driver_engaged, op_engaged, standstill, wrong_gear, car_speed):
    ...
    if certainly_distracted or maybe_distracted:
      # Driver monitoring fully disabled (standstill + driving) — True short-circuits all conditions
      if not (True or standstill or standstill_orange_exemption or always_on_red_exemption or (always_on_lowspeed_exemption and _reaching_audible)):
